...
describe('route.generate.ts file', () => {
    ...
    describe('generateRoute function', () => {
        ...
        it('should abort not using a given rest-method', async () => {
            ...
            chai.expect(
                consoleErrorStub.calledWith(
                    messages.generateRoute.invalid_method
                )
            ).to.deep.eq(
                true,
                'console.error should log invalid_method messgae'
            );
        });
        ...
        it('should abort when route already exists', async () => {
            ...
            chai.expect(
                consoleErrorStub.calledWith(messages.generateRoute.exists)
    ...
    describe('generateRouteHandler function', () => {
        ...
        ) => Promise<void> = route.__get__('generateRouteHandler');
        ...
        it('should start generateRoute with given parameters', async () => {
            ...
            chai.expect(generateRouteStub.lastCall.args[0]).to.deep.eq(
                '/test',
                'should be the given routePath'
            );
            chai.expect(generateRouteStub.lastCall.args[1]).to.deep.eq(
                'get',
                'should be the given method'
            );
