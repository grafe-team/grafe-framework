 ...
 *
 * @param config - Config where the routeTree should be added
 * @param config.middlewares - All the middlewares that are available to use
 * @param config.middlewares[].value - The value which is the selector for the middleware
